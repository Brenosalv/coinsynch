...
export function Footer({ className }: FooterProps) {
  return (
    <footer
      className={cn(
        className,
        'mt-[112px] max-sm:mt-[56px] bg-[linear-gradient(138deg,_#FBAB34_0%,_#AD721A_100%)] overflow-x-hidden overflow-y-hidden flex items-center justify-center relative',
      )}
    >
